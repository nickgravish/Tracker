...
video2 = Tracker(file, verbose='True', frame_range=(1000,100), min_object_size=20)
...
# vv1.video_stream.timeLineChanged.connect(vv2.setCurrentIndex)
# vv2.video_stream.timeLineChanged.connect(vv1.setCurrentIndex)
